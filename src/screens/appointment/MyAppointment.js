                ...
                <Content>
                    ...
                    <View style={styles.backgroundImage}>
                        <View style={styles.mainbody}>
                            ...
                            <View style={{ marginLeft: 20, marginTop: 5, marginRight: 10, marginBottom: 5, flexDirection: 'row', justifyContent: 'center' }}>
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Auth')} style={buttonStyles.appointmentTransparentButtonStyle}>
                                    <Text style={[buttonStyles.primaryButtonTextStyle, { color: '#7C7C7C', fontSize: 13, fontStyle: font.REGULAR }]}>Cancel my appointment</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => this.props.navigation.navigate('Auth')} style={buttonStyles.appointmentButtonStyle}>
                                    <Text style={[buttonStyles.primaryButtonTextStyle, { fontSize: 13, fontStyle: font.REGULAR }]}>My Appointment</Text>
                                </TouchableOpacity>
